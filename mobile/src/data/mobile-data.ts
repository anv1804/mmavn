export type { Fighter, Division, Gym, Promotion, Ranking, MmaEvent, Fight, ChampionshipBelt } from '../types';

// -------------------------------------------------------------
// DỮ LIỆU ĐỒNG BỘ CHO MOBILE APP MMAVN HUB (REACT NATIVE / EXPO)
// Cập nhật tháng 9/2026: 30+ võ sĩ, 25 CLB, 3 giải đấu, BXH & sự kiện
// -------------------------------------------------------------
